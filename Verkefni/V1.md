...
1. Notaðu [fjölsviðsmæli](https://youtu.be/SLkPtmnglOI?t=324) (e. multimeter) og mældu [viðnámið](https://www.instructables.com/Resistors/) sem þú átt. Prófaðu að lesa úr litahringjunum á viðnámi, færðu sömu gildi? Um það bil, það fór oftast sma yfir
...
1. Prófaðu að færa til viðnámið í rásinni (færðu það hinu megin við LED peruna), breytist eitthvað? Já það virkar ekki
1. Prófaðu að skipta út viðnáminu í rásinni fyrir eitthvað annað viðnám, er einhver munur á birtunni (notaðu 1KΩ og 10KΩ)? dimmra ljós með 1k enginn munur á 10k
...
1. Mældu [spennufallið](https://youtu.be/SLkPtmnglOI?t=160) yfir:  
   1. Aðra LED peruna 1.934V
   2. Báðar LED perurnar 0.390V
   3. Viðnámið -1184
1. Getur þú bætt við þriðju LED? Hvað gerist? neibb kveiknar ekki á því
